...
export class SlormancerActivableService {
    ...
    constructor(private slormancerTemplateService: SlormancerTemplateService,
        ...
        this.PRIME_TOTEM_SKILL_NAME = {
            [HeroClass.Huntress]: this.slormancerDataService.getGameDataSkill(HeroClass.Huntress, PRIME_TOTEM_SKILL[HeroClass.Huntress])?.CH_NAME ?? '',
            [HeroClass.Mage]: this.slormancerDataService.getGameDataSkill(HeroClass.Mage, PRIME_TOTEM_SKILL[HeroClass.Mage])?.CH_NAME ?? '',
            [HeroClass.Warrior]: this.slormancerDataService.getGameDataSkill(HeroClass.Warrior, PRIME_TOTEM_SKILL[HeroClass.Warrior])?.CH_NAME ?? '',
        }
