    ...
    public getAncestralLegacy(ref: number, baseRank: number, bonusRank: number = 0): AncestralLegacy | null {
        ...
        if (gameData !== null) {
            ...
            ancestralLegacy = {
                ...
                relatedBuffs: this.extractBuffs(gameData.CH_DESCRIPTION, data !== null && data.additionalBuffs ? data.additionalBuffs : []),
                relatedMechanics: this.extractMechanics(gameData.CH_DESCRIPTION, values, data !== null && data.additionalMechanics ? data.additionalMechanics : []),
