    ...
    public updateSkillView(skill: Skill) {
        if (skill.specialization !== null) {
            ...
            if (specialization !== null) {
                skill.specializationName = specialization.CH_NAME;
            }
        }
    ...
    public getUpgrade(upgradeId: number, heroClass: HeroClass, baseRank: number): SkillUpgrade | null {
        ...
        if (gameDataSkill !== null && (gameDataSkill.TYPE == SkillType.Passive || gameDataSkill.TYPE === SkillType.Upgrade)) {
            ...
            upgrade = {
                ...
                relatedClassMechanics: this.extractSkillMechanics(gameDataSkill.CH_DESCRIPTION, heroClass, dataSkill === null || dataSkill.additionalClassMechanics === undefined ? [] : dataSkill.additionalClassMechanics, gameDataSkill.REF),
                relatedMechanics: [],
                relatedBuffs: this.extractBuffs(gameDataSkill.CH_DESCRIPTION),
            ...
            upgrade.relatedMechanics = this.extractMechanics(gameDataSkill.CH_DESCRIPTION, values, dataSkill !== null && dataSkill.additionalMechanics ? dataSkill.additionalMechanics : []);
